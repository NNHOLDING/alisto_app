...
logo_url = https://drive.google.com/uc?export=view&id=TU_ID_DEL_LOGO  # ← Reemplaza con tu ID real
...
empleados = {51857: "Carlos Carvajal", 59157: "Allan Valenciano", 59683: "Jerlyn Villalobos", 50403: "Admin1"}

 

# 🖱️ Tabs

tab1, tab2 = st.tabs(["📦 Formulario principal", "🏷️ Generador de etiqueta"])
...
with tab2:
    ...
    if st.button("🖨️ Imprimir etiquetas"):
        ...
        impresora_ip = "192.168.1.50"  # ← Cambia esto por la IP real de tu impresora
...
"""
        ...
        if exito:
            ...
            st.success(f"✅ Se enviaron {cantidad_etiquetas} etiquetas a la impresora 60SANJOSE")
